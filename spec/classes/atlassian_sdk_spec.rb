  ...
  context "Should install SDK 5.0.3" do
    ...
    it do
      should contain_exec('Download atlassian-plugin-sdk-5.0.3.tar.gz').with(
        'command' => 'wget -q https://maven.atlassian.com/content/groups/public/com/atlassian/amps/atlassian-plugin-sdk/5.0.3/atlassian-plugin-sdk-5.0.3.tar.gz -O /opt/atlassian-plugin-sdk-5.0.3.tar.gz'
      )
  ...
  context "Should install SDK 5.0.3 and 4.2.20" do
    ...
    it do
      ...
      should contain_exec('Download atlassian-plugin-sdk-4.2.20.tar.gz').with(
        'command' => 'wget -q https://maven.atlassian.com/content/groups/public/com/atlassian/amps/atlassian-plugin-sdk/4.2.20/atlassian-plugin-sdk-4.2.20.tar.gz -O /opt/atlassian-plugin-sdk-4.2.20.tar.gz'
      )
